...
class MataPelajaranController extends AppController
{
    ...
    public function ajaxViewMataPelajaran(){
        if ($this->request->is('ajax')):
            ...
            $getSiswaKelas = $this->SiswaKelas->find('all',
            [
                'conditions'=>
                [
            ...
            $getKelasYangDiajar = $this->KelasYangDiajar->find('all',
                    [
                        'conditions'=>
                        [
                ...
                ->toList();
            $output = [];
            foreach ($getKelasYangDiajar as $key => $value) {
                ...
                $getMataPelajaran = $this->MataPelajaran->find('all',
                    [
                        'conditions'=>
                        [
                        'id'=>$getGuru->id_mapel
                ...
                $set = [
                    'mapel'      => $getMataPelajaran->mata_pelajaran,
