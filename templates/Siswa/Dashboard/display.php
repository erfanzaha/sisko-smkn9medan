        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="orang-tuaa-tab" data-toggle="tab" href="#orang-tua" role="tab"
                            aria-controls="orang-tua" aria-selected="false">Orang Tua</a>
                    </li>
                </ul>
                <div class="tab-content m-t-15" id="myTabContent">
                    <div class="tab-pane fade show active" id="data-siswa" role="tabpanel"
                        aria-labelledby="data-siswa-tab">
                        <button class='btn btn-primary' title="Tambah Jadwal Pembayaran" onclick="edit();"
                            data-effect="effect-slide-in-bottom"> <i class="anticon anticon-edit"></i>
                            &nbsp;
                            Edit Profil
                        </button>
                        <hr>
