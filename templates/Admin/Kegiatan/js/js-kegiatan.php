        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data) {
                    return '<img src="/portal/images/gallery/'+data.gambar+'" class="img-thumbnail" style="width:100px;">';
                }
            },
            {
                "data": null,
...
function tutup() {
    ...
    $('#exampleModalCenterTitle').text('Tambah Kegiatan');
    ...
    $.ajax({
        ...
        success: function(res) {
            if (res.icon != null && res.icon != '') {
                ...
                $('#exampleModalCenterTitle').text('Edit Kegiatan');
            }
        },
        error: function() {
            swal({
